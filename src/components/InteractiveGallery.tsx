...
const InteractiveGallery = () => {
  ...
  const galleryItems: GalleryItem[] = [
    ...
    },
    {
      ...
      date: 'July 2024',
      aspectRatio: 'aspect-rectangle',
      story: 'Corpe photography that captures the essence of modern business leaders. Clean, professional lighting that emphasizes confidence and approachability.',
    ...
    },
    {
      ...
      date: 'July 2024',
      aspectRatio: 'aspect-rectangle',
      story: 'Corpo photography that captures the essence of modern business leaders. Clean, professional lighting that emphasizes confidence and approachability.',
    ...
    },
    {
      ...
      id: 14,
      category: 'Portraits',
      title: 'Trail of Fire 14',
      description: 'Candid coffee moment',
